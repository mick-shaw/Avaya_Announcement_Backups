...
my $ssh_command = '/usr/bin/ssh -o StrictHostKeyChecking=no -o UserKnownHostsFile=/dev/null';
...
my %pbx_config = (
  CM1		   => [ 'CM1',   '1.1.1.2',  '5022', 'username',  'Password',  'ssh', '' ],
  CM2		   => [ 'CM2',   '2.2.2.2',  '5022', 'username',  'Password',  'ssh', '' ],
  CM3	           => [ 'CM3', '3.3.3.3',  '5022', 'username',  'Password',  'ssh', '' ],
  CM4	           => [ 'CM4', '4.4.4.4', '5022','username', 'Password', 'ssh', ''],
  CM5	           => [ 'CM5', '5.5.5.5', '5022','username', 'Password', 'ssh', ''],
  );
...
#=============================================================
	...
	if ( $connection_type eq 'telnet' ) {
		...
		$command = "$ssh_command -p $port -l $username $host";
	}
